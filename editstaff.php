          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <form method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>?id=<?php echo $_GET['id'] ?>" enctype="multipart/form-data">
                <input type="hidden" name="staff_id" id="staff_id" value="<?php echo $data[0]->id ?>">
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <input type="name" name="email" id="email" class="form-control" value="<?php echo $data[0]->email ?>">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" name="phone" id="phone" class="form-control" value="<?php echo $data[0]->phone ?>">
                   ...
                   <div class="form-group">
                    ...
                    <input type="file" name="image" id="image" class="form-control" value="<?php echo $data[0]->image ?>">
                  ...
                  <div class="form-group">
                    <input type="submit" class="btn btn-success" name="editstaff" id="editstaff">
                  </div>
                </form>
              </div>
